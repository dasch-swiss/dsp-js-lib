...
export class Endpoint {
     ...
     */
    protected httpGet(path?: string, headerOpts?: IHeaderOptions): Observable<AjaxResponse<T>> {
     ...
     * @param headerOpts additional headers, if any.
     */
    protected httpPost(path?: string, body?: any, contentType: "json" | "sparql" = "json", headerOpts?: IHeaderOptions): Observable<AjaxResponse<T>> {
     ...
     * @param headerOpts additional headers, if any.
     */
    protected httpPut(path?: string, body?: any, contentType: "json" = "json", headerOpts?: IHeaderOptions): Observable<AjaxResponse<T>> {
     ...
     * @param headerOpts additional headers, if any.
     */
    protected httpPatch(path?: string, body?: any, contentType: "json" = "json", headerOpts?: IHeaderOptions): Observable<AjaxResponse<T>> {
     ...
     * @param headerOpts additional headers, if any.
     */
    protected httpDelete(path?: string, headerOpts?: IHeaderOptions): Observable<AjaxResponse<T>> {
