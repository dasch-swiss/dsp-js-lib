...
describe("ResourcesEndpoint", () => {
    ...
    describe("method updateResourceMetadata", () => {
        ...
        it("should update a resource's label", done => {
            ...
            updateResourceMetadata.newModificationDate = "2022-03-09T13:13:38.392919Z";
            ...
            knoraApiConnection.v2.res.updateResourceMetadata(updateResourceMetadata).subscribe(
                (res: UpdateResourceMetadataResponse) => {
                    ...
                    expect(res.lastModificationDate).toEqual("2022-03-09T13:13:38.392919Z");
                    done();
                }
            );
            ...
            expectedPayload["http://api.knora.org/ontology/knora-api/v2#newModificationDate"]["@value"] = "2022-03-09T13:13:38.392919Z";
        ...
        it("should update a resource's label submitting the last modification date", done => {
            ...
            updateResourceMetadata.newModificationDate = "2022-03-09T13:13:39.273668Z";
            ...
            knoraApiConnection.v2.res.updateResourceMetadata(updateResourceMetadata).subscribe(
                (res: UpdateResourceMetadataResponse) => {
                    ...
                    expect(res.lastModificationDate).toEqual("2022-03-09T13:13:39.273668Z");
                    done();
                }
            );
            ...
            expectedPayload["http://api.knora.org/ontology/knora-api/v2#newModificationDate"]["@value"] = "2022-03-09T13:13:39.273668Z";
