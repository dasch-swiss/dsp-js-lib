...
describe("ResourcesEndpoint", () => {
    ...
    describe("method updateResourceMetadata", () => {
        ...
        it("should update a resource's label", done => {
            ...
            updateResourceMetadata.newModificationDate = "2021-11-26T08:39:03.827765Z";
            ...
            knoraApiConnection.v2.res.updateResourceMetadata(updateResourceMetadata).subscribe(
                (res: UpdateResourceMetadataResponse) => {
                    ...
                    expect(res.lastModificationDate).toEqual("2021-11-26T08:39:03.827765Z");
                    done();
                }
            );
            ...
            expectedPayload["http://api.knora.org/ontology/knora-api/v2#newModificationDate"]["@value"] = "2021-11-26T08:39:03.827765Z";
        ...
        it("should update a resource's label submitting the last modification date", done => {
            ...
            updateResourceMetadata.newModificationDate = "2021-09-30T16:41:47.928709Z";
            ...
            knoraApiConnection.v2.res.updateResourceMetadata(updateResourceMetadata).subscribe(
                (res: UpdateResourceMetadataResponse) => {
                    ...
                    expect(res.lastModificationDate).toEqual("2021-09-30T16:41:47.928709Z");
                    done();
                }
            );
            ...
            expectedPayload["http://api.knora.org/ontology/knora-api/v2#newModificationDate"]["@value"] = "2021-09-30T16:41:47.928709Z";
