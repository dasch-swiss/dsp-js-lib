...
describe("Test class ApiResponseError", () => {
    ...
    describe("Test method fromErrorString()", () => {
        ...
        const responseData = ApiResponseData.fromAjaxResponse(new AjaxResponse({} as any, {} as any, { url: 'test-url', method: 'GET', async: true, headers: {}, timeout: 0, user: undefined, password: undefined, crossDomain: false, responseType: 'json', withCredentials: false }));
