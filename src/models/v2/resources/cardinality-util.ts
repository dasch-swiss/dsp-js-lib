...
export namespace CardinalityUtil {
     ...
     * @param entityInfo class information.
     */
    export const createValueForPropertyAllowed = (propertyIri: string, numberOfInstances: number, entityInfo: ResourceClassDefinition): boolean => {
     ...
     * @param entityInfo class information.
     */
    export const deleteValueForPropertyAllowed = (propertyIri: string, numberOfInstances: number, entityInfo: ResourceClassDefinition): boolean => {
