...
This will download the test data for the DSP-API release which is set in `vars.mk`.

To integrate test data generated by DSP-API, the following scripts can be used.

1. `npm run integrate-admin-test-data <path-to-generated-client-code>`: integrates generated test data for the DSP-API admin API.
1. `npm run integrate-system-test-data <path-to-generated-client-code>`: integrates generated test data for the DSP-API system API.
...
DSP-JS-LIB is compatible with a specified release of DSP-API.
